...
def data_update(userid):
    ...
    address =tk.StringVar(update_data1)
        ...
        #username
    tk.Label(master=update_data1,text="Update Profile",font="none 20 bold",fg='white',bg="black").grid()
    
    tk.Label(master=update_data1,text="name",width=10,bg="black",fg="red").grid(row=1)
    tk.Entry(master=update_data1,textvariable=name,bg="red").grid(column=1,row=1)
    #age
    tk.Label(master=update_data1,text="age",width=10,bg="black",fg="red").grid(row=2)
    tk.Entry(master=update_data1,textvariable=age,bg="red").grid(column=1,row=2)
    #address
    tk.Label(master=update_data1,text="address",width=10,bg="black",fg="red",font="none 10 bold").grid(row=4)
    tk.Entry(master=update_data1,textvariable=address,bg="red").grid(column=1,row=4)
    update_entry1=partial(update_entry, name,age,address,userid)  
    tk.Button(master=update_data1,text="Proceed",command=update_entry1,width=10).grid(row=6,column=1,pady=2)
    tk.Button(master=update_data1,text="Exit",command=update_data1.destroy,width=10).grid(row=6,column=2,pady=2)
...
def userInfo(bgColor,fgColor):
    def call_result(n1):  
        ...
        if num1 not in user1.keys():
            ...
            tk.Label(master=profile,text="Name",width=20,bg="black",fg="red",font="none 12 bold",justify=LEFT).grid(row=6,pady=3)
            tk.Label(master=profile,text=user1[num1]['name'],bg="black",fg="white",font="none 9",justify=LEFT).grid(column=1,row=6,pady=3,padx=4)
          #age
            tk.Label(master=profile,text="Age",width=20,bg="black",fg="red",font="none 12 bold",justify=LEFT).grid(row=7,pady=3)
            tk.Label(master=profile,text=user1[num1]['age'],bg="black",fg="white",font="none 9",justify=LEFT).grid(column=1,row=7,pady=3)
          #address
            tk.Label(master=profile,text="Address",width=20,bg="black",fg="red",font="none 12 bold",justify=LEFT).grid(row=8,pady=3)
            tk.Label(master=profile,text=user1[num1]['address'],bg="black",fg="white",font="none 9",justify=LEFT).grid(column=1,row=8,pady=3)
           #salary
            tk.Label(master=profile,text="Salary",width=20,bg="black",fg="red",font="none 12 bold",justify=LEFT).grid(row=10,pady=3)
            tk.Label(master=profile,text=user1[num1]['salary'],bg="black",fg="white",font="none 12 bold",justify=LEFT).grid(column=1,row=10,pady=3)
          #attendance
            tk.Label(master=profile,text="Attendance",width=20,bg="black",fg="red",font="none 12 bold",justify=LEFT).grid(row=9,pady=3)
            tk.Label(master=profile,text=user1[num1]['attendance'],bg="black",fg="white",font="none 9",justify=LEFT).grid(column=1,row=9,pady=3)
            data_update1=partial(data_update, num1)

            tk.Button(master=profile,text="Update Data",command=data_update1,width=10).grid(row=12,column=1,pady=3)
            tk.Button(master=profile,text="Exit",command=profile.destroy,width=10).grid(row=12,column=2,pady=3)
...
def create_profile(bgColor,fgColor):
    ...
    def call_result(name,age,address):  
        ...
        tk.Label(master=create_profile,text=uni_print,font="none 10 bold",fg="black").grid(row=8,column=3)
